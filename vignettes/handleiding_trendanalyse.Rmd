...
stap 3c) dient de trendanalyse volgens iteratie 1, 2 en 3 te worden uitgevoerd.
...
Aan de hand van een visuele inspectie wordt bepaald of er een verschil is tussen 
de resultaten van iteratie 1 en 2. Als de resulaten van iteratie 1 en 2 niet 
verschillen dan hebben de rapportagegrenzen in de dataset geen invloed op het 
resultaat van de trendtoets. Verdere actie is niet nodig. Het resultaat van 
iteratie 1 kan worden gebruikt.

Als de resultaten van iteratie 1 en 2 na een visuele inspectie wel verschillen 
dan dienen de reeksen op filterniveau visueel te worden geïnspecteerd op de 
aanwezigheid van uitbijters in de rapportagegrens of op kunstmatige trends. Op 
basis van een expert beoordeling (zie stap 4d) kunnen uitbijters en/of reeksen 
worden verwijderd. Dit leidt tot een nieuwe dataset (iteratie 3) waarop de 
trendanalyse opnieuw kan worden uitgevoerd (volgens de methode van iteratie 1).
...
Iteratie 3: < rapportagegrens wordt geherdefinieerd als de helft van de 
rapportagegrens.
