...
figuur <- mktrends("5f1", d, dw = dw, make.plot = TRUE)
...
figuur0.5 <- mktrends("17f1", d, dw = dw, make.plot = TRUE)
...
figuur0 <- mktrends("17f1", d, dw = dw, make.plot = TRUE)
...
statistiek <- trendReversal("213f1", d, trim = FALSE, make.plot = FALSE)
figuur <- trendReversal("213f1", d, dw = dw, trim = FALSE, make.plot = TRUE)
