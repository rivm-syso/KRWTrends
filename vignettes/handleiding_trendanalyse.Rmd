...
Deze functie wordt aangeroepen binnen de `mktrends` functie en
staat standaard aan, maar kan ook uitgezet worden. Zie onderstaand:
...
# Pas RG niet aan
figuur <- mktrends("213f1", d, dw = dw, rpDL = FALSE, make.plot = TRUE)
print(figuur)
